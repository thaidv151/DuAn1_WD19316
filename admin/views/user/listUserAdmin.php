                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($user['role_id'] === 1) { ?>
                                        <a style="text-decoration: none;" onclick="return confirm('Bạn có muốn thay đổi trạng thái của người này ?')" class="text-dark" href="<?= BASE_URL_ADMIN . '?act=change-status-user&user_id=' . $user['id'] ?>">
