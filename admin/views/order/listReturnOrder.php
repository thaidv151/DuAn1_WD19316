...
<div class="col-12">
    <div class="card">
        <div class="card-header  alert-primary">
            <h4 class="card-title">Danh sách đơn hàng hoàn hàng</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="example" class="display min-w850">
                    ...
                    <tbody>
                        ...
                        <?php if (!empty($listReturnOrder)): ?>
                            <?php foreach ($listReturnOrder as $key => $newOrder): ?>
                                <tr class="text-center">
                                    <td><?= $newOrder['order_code'] ?></td>
                                    <td><?= $newOrder['customer_phone'] ?></td>
                                    <td><?= $newOrder['created_at'] ?></td>
                                    <td>
                                        <p class="badge bg-warning"><?= $newOrder['status'] ?></p>
                                    </td>
