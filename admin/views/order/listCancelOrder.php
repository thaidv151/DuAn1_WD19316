...
<div class="col-12">
    <div class="card">
        <div class="card-header  alert-primary">
            <h4 class="card-title">Danh sách đơn hàng huỷ</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="example" class="display min-w850">
                    ...
                    <tbody>
                        ...
                        <?php if (!empty($listCancelOrder)): ?>
                            <?php foreach ($listCancelOrder as $key => $newOrder): ?>
                                <tr class="text-center">
                                    <td><?= $newOrder['order_code'] ?></td>
                                   
                                    <td><?= $newOrder['created_at'] ?></td>
                                    <td>
                                        <p class="badge bg-danger"><?= $newOrder['status'] ?></p>
                                    </td>
