...
<!-- Mirrored from vora.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Nov 2024 02:08:13 GMT -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?= BASE_URL_ADMIN ?>" class="brand-logo">
                <div class="">
                    <img style="width:70px; " src="../uploads/logo1.png" alt="">
                </div>
                <div class="brand-title ms-3">
                    <img style="width:90px;" src="../uploads/logo-text.png" alt="">
                </div>
            </a>
