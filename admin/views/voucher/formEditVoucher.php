...
<div class="col-12 card">
    <div class="div m-4">
        ...
        <?php } ?>
        <form action="<?= BASE_URL_ADMIN . '?act=post-edit-voucher' ?>" method="POST" class="form-group row " enctype="multipart/form-data">
            ...
            <div class="form-group col-12">
                ...
                <?php } ?>
                <input class="form-control" type="text" name="title_voucher" placeholder="Tiêu đề của voucher" value="<?= $voucher['title_voucher'] ?>">
            </div>
            <div class="form-group col-12">
                <label>Mô tả</label>
                ...
                <?php } ?>
                <textarea class="form-control" type="text" name="description"><?= $voucher['description'] ?></textarea>
            </div>
            <div class="form-group col-12">
                ...
                <?php } ?>
                <input class="form-control" type="datetime-local" name="end_date" value="<?= $voucher['end_date'] ?>">
            </div>
            <div class="form-group col-12">
                ...
                <?php } ?>
                <input class="form-control" type="number" placeholder="Phần trăm giảm giá" name="disscount_value" value="<?= $voucher['disscount_value'] ?>">
            </div>
            <div class="form-group col-12">
                ...
                <?php } ?>
                <input class="form-control" type="text" placeholder="Giới hạn giá trị có thể giảm" name="max_disscount_amount" value="<?= $voucher['max_disscount_amount'] ?>">
            </div>
            <div class="form-group col-12">
                ...
                <?php } ?>
                <input class="form-control" type="text" placeholder="Điều kiện để sử dụng" name="min_order_amount" value="<?= $voucher['min_order_amount'] ?>">
            </div>
            <div class="form-group col-12">
                ...
                <?php } ?>
                <input class="form-control" type="number" placeholder="Số lượng giới hạn" name="quantity_limit" value="<?= $voucher['quantity_limit'] ?>">
            </div>
    ...
    <div style="margin-top: 10px;" class="form-group col-12 row">
        ...
        <button id="submit" class="btn btn-success col-2" type="submit">Cập nhật</button>
    </div>
